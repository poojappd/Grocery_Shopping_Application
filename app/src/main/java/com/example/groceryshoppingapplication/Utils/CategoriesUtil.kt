...
//    val childCategoryArray : MutableList<MutableList<ChildCategoryRowData>>
    val categoryMap:Map<GeneralCategory,List<SubCategory>> =
        mapOf(
            GeneralCategory.FRUITS_AND_VEGETABLES to listOf(
                SubCategory.HERBS_AND_SEASONINGS,
                SubCategory.FRESH_FRUITS, SubCategory.FRESH_VEGETABLES, SubCategory.CUTS_AND_SPROUTS, SubCategory.EXOTIC_FRUITS_AND_VEGGIES, SubCategory.FLOWER_BOUQUETS_BUNCHES),
            ...
            GeneralCategory.GARDEN_AND_PETS to listOf(
                SubCategory.GARDENING_TOOLS,
                SubCategory.SEEDS, SubCategory.DOG_FOOD, SubCategory.CAT_FOOD,
                SubCategory.OTHER_PET_FOOD, SubCategory.PET_ACCESSORIES),
