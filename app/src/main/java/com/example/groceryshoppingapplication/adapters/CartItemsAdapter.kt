...
class CartItemsAdapter(private val cartItems: List<CartItemEntity>, private val cartItemData: List<CartItemData>) :
    ...
    override fun onBindViewHolder(holder: CartItemsViewHolder, position: Int) {
        holder.apply {
            ...
            image.setImageBitmap(getBitmapFromAsset(cartItems.get(position).productCode.toString(),true))
